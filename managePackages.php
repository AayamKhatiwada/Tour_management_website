          ...
          <div class="w3l-table-info">
            ...
            <table id="table">
              ...
              while($rows = mysqli_fetch_array($result)){?>
                <tr>
                  <td data-th="#"><span class="bt-content"><?php echo $rows[0];?></span></td>
                  <td data-th="Name"><span class="bt-content"><?php echo $rows[1];?></span></td>
                  <td data-th="Type"><span class="bt-content"><?php echo $rows[2];?></span></td>
                  <td data-th="Location"><span class="bt-content"><?php echo $rows[3];?></span></td>
